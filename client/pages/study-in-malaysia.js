    ...
    <div className="min-h-screen">
      ...
      <section className="relative pt-24 pb-16 overflow-hidden">
        <div className="absolute inset-0 z-0">
          <Image
            src="/images/destination-malaysia.jpg"
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl animate-slide-up-fade">
            ...
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-white tracking-tight leading-[1.1] mb-6 uppercase">
              Study In <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 to-blue-400">Malaysia.</span>
            </h1>
            <p className="text-lg md:text-xl text-blue-50 font-light max-w-2xl leading-relaxed normal-case">
              Affordable, high-quality education in a multicultural environment. Experience a tropical paradise while earning an internationally recognized degree.
            </p>
          </div>
        </div>
      </section>
            ...
            <div className="lg:col-span-8 space-y-20">
              <div className="animate-slide-up-fade">
                ...
                <p className="text-xl text-neutral-800 leading-relaxed font-light normal-case">
                  Malaysia offers a unique blend of modern infrastructure and rich cultural heritage. With numerous
                  international branch campuses, English-taught programs, and a strategic location in Southeast Asia,
                  it's an excellent choice for students seeking global value and diversity.
                </p>
              </div>
              ...
              <div className="grid sm:grid-cols-2 gap-6 animate-slide-up-fade" style={{ animationDelay: '100ms' }}>
                {[
                  { icon: '💰', title: 'Affordable Education', desc: 'Low tuition fees and living costs compared to Western destinations.' },
                  { icon: '🌏', title: 'Multicultural', desc: 'Safe and harmonious society with rich cultural diversity.' },
                  { icon: '🗣️', title: 'English Programs', desc: 'Wide range of programs taught entirely in English.' },
                  { icon: '📍', title: 'Strategic Gateway', desc: 'Perfectly positioned as a gateway to the Asia-Pacific region.' },
                  { icon: '🎓', title: 'Global Quality', desc: 'Home to top-ranked local and international branch campuses.' },
                  { icon: '🏝️', title: 'Lifestyle Excellence', desc: 'Exceptional quality of life in a tropical paradise.' }
                ].map((item, i) => (
              ...
              <div className="animate-slide-up-fade" style={{ animationDelay: '200ms' }}>
                ...
                <div className="space-y-4">
                  {[
                    { name: 'University of Malaya (UM)', desc: 'Malaysia\'s oldest and highest-ranked university, global premier research hub.' },
                    { name: 'Universiti Teknologi Malaysia (UTM)', desc: 'Leading technical university specializing in engineering and high technology.' },
                    { name: 'Taylor\'s University', desc: 'Premier private university globally recognized for hospitality and business.' },
                    { name: 'Monash University Malaysia', desc: 'Strategic Australian branch campus offering elite global education standards.' }
                  ].map((uni, i) => (
              ...
              <div className="sticky top-24 space-y-12">
                ...
                <div className="bg-neutral-900 text-white p-8 rounded-[2rem] shadow-2xl animate-slide-up-fade" style={{ animationDelay: '300ms' }}>
                  ...
                  <ul className="space-y-6">
                    {[
                      { label: 'English Proficiency', val: 'IELTS 5.5-6.0' },
                      { label: 'Academic Records', val: 'Transcripts & Certs' },
                      { label: 'Passport Status', val: 'Valid for 12 months+' },
                      { label: 'Medical Clearance', val: 'Health Certificate' },
                      { label: 'Financial Proof', val: 'Bank Statements' }
                    ].map((item, i) => (
                  ...
                  <div className="space-y-8">
                    <div>
                      ...
                      <div className="space-y-3">
                        <div className="flex justify-between text-sm">
                          ...
                          <span className="font-bold text-neutral-900">$3,000 - $6k/yr</span>
                        </div>
                        <div className="flex justify-between text-sm">
                          <span className="text-neutral-500 normal-case">Postgraduate</span>
                          <span className="font-bold text-neutral-900">$4,000 - $8k/yr</span>
                        </div>
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="flex justify-between text-sm">
                          <span className="text-neutral-500 normal-case">Food & Transport</span>
                          <span className="font-bold text-neutral-900">$200 - $300/mo</span>
                        </div>
                      </div>
                    </div>
                  </div>
          ...
          <div className="mt-32 pb-16 border-b border-neutral-100 animate-slide-up-fade">
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <div className="relative aspect-video rounded-[2.5rem] overflow-hidden group shadow-2xl">
                <Image
                  src="/images/destination-malaysia-grid.jpg"
                  alt="Student Life"
                  fill
                ...
                <div className="absolute bottom-8 left-8">
                  <p className="text-white text-2xl font-bold uppercase tracking-tight">Kuala Lumpur Skyline</p>
                </div>
              </div>
              <div className="space-y-8">
                <p className="text-xl text-neutral-600 font-light leading-relaxed normal-case">
                  Life in Malaysia is a seamless blend of traditional culture and hyper-modern infrastructure. Students enjoy a high quality of life with access to some of the world's best cuisine and travel opportunities.
                </p>
                <div className="grid gap-6">
                  {[
                    "Unparalleled culinary diversity and night markets.",
                    "Seamless travel to tropical islands and heritage sites.",
                    "State-of-the-art public infrastructure in urban hubs."
                  ].map((text, i) => (
          ...
          <div className="mt-32 relative group">
            ...
            <div className="relative bg-neutral-900 text-white p-12 md:p-20 rounded-[3rem] text-center overflow-hidden">
              ...
              <h2 className="text-3xl md:text-5xl lg:text-6xl font-bold mb-6 tracking-tight uppercase leading-none relative z-10">
                ...
                <span className="text-emerald-400 italic font-light lowercase">in Malaysia.</span>
              </h2>
              <p className="text-blue-100/60 font-light text-lg mb-12 normal-case max-w-2xl mx-auto relative z-10">
                Our advisors are standing by to manage your transition to Malaysia's elite academic institutions with professional precision.
              </p>
