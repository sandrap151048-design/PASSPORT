...
export default function Services() {
  ...
  return (
    <div className="min-h-screen bg-zinc-50 font-sans text-zinc-900 selection:bg-black selection:text-white uppercase">
      <Navbar />
      ...
      <section className="py-24 bg-white relative overflow-hidden">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="flex flex-col md:flex-row items-center justify-between mb-12 gap-6 animate-slide-up-fade">
              ...
              >
                ...
                <div className="p-8 pb-10">
                  ...
                  <div className="flex items-center justify-between mt-auto pt-4 border-t border-neutral-100">
                    <span className="text-[9px] font-black text-brand-blue uppercase tracking-widest group-hover:translate-x-2 transition-transform">View Details</span>
                    <svg className="w-4 h-4 text-brand-blue" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.5" d="M14 5l7 7m0 0l-7 7m7-7H3"></path></svg>
                  </div>
                </div>
              </Link>
            ))}
      ...
      <section className="py-24 bg-neutral-900 text-white relative overflow-hidden uppercase">
        ...
        <div className="container mx-auto px-4 max-w-7xl relative z-10 text-center mb-20 animate-slide-up-fade">
          ...
          <p className="text-blue-100/60 font-light max-w-xl mx-auto normal-case leading-relaxed">A systematic approach for optimized results.</p>
        </div>
        <div className="container mx-auto px-4 max-w-7xl grid md:grid-cols-3 gap-8">
          {[
            { step: '01', title: 'Analysis', desc: 'Audit of background and potential.' },
            { step: '02', title: 'Mapping', desc: 'Curating a bespoke roadmap.' },
            { step: '03', title: 'Execution', desc: 'Precision-managed dossier preparation.' }
          ].map((phase, idx) => (
            <div key={idx} className="p-8 bg-white/5 border border-white/10 rounded-[2rem] animate-slide-up-fade" style={{ animationDelay: `${idx * 150}ms` }}>
              <h3 className="text-xl font-bold mb-4 uppercase">{phase.title}</h3>
              <p className="text-blue-100/60 text-sm normal-case">{phase.desc}</p>
            </div>
          ))}
        </div>
      </section>
